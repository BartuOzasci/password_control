  ...
  return (
    <div className="px-4 py-6 space-y-5 animate-fade-in">
      ...
      <div className="text-center mb-2">
        <h2 className="text-lg font-bold text-white">Ne yapmak istersiniz?</h2>
      ...
      <div className="space-y-4">
        {cards.map((card, i) => (
          ...
          >
            {/* Icon */}
            <div className="w-16 h-16 flex items-center justify-center bg-white/15 backdrop-blur rounded-2xl text-white shrink-0">
              {card.icon}
            </div>
            ...
            <div>
              ...
              <p className="text-white/70 text-sm mt-0.5">{card.subtitle}</p>
            </div>
      ...
      <div className="mt-8 text-center">
        <div className="inline-flex items-center gap-2 bg-dark-card border border-white/5 rounded-full px-4 py-2">
          ...
          <span className="text-xs text-slate-500">Tüm veriler cihazınızda şifreli saklanır</span>
        </div>
      </div>
    </div>
  );
